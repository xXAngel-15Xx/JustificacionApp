              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (registerFormProvider.typeUserSelected ==
                        TypeUser.alumno)
                      TextFormField(
                    ...
                    if (registerFormProvider.typeUserSelected ==
                      ...
                      MultiSelectDialogField<int>(
                        items: gruposService.grupos
                            .map((e) => MultiSelectItem(e.id, e.nombre))
                            .toList(),
                        onConfirm: (values) {
                      ...
                      onPressed: () async {
                        if (registerFormProvider.isValidForm()) {
                          if (registerFormProvider.typeUserSelected ==
                              TypeUser.alumno) {
                            final response =
                                await cuentasService.registrarAlumno(
                                    registerFormProvider.user,
                                    registerFormProvider.grupoIdSeleccionado);
                          ...
                          if (registerFormProvider.typeUserSelected ==
                              TypeUser.profesor) {
                            final response =
                                await cuentasService.registerProfesor(
                                    registerFormProvider.user,
                                    registerFormProvider
                                        .gruposIdsSeleccionados);
                          ...
                          showDialog(
                              ...
                              builder: (_) => const AlertDialogCustom(
                                    title: '¡Aviso!',
                                    message:
                                        'Tienes que llenar todos los campos del formulario',
                                  ));
                        }
                      },
                      style: btnPurple(),
